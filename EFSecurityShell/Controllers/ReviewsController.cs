...
namespace Team2_AdmissionManagement.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ApplicantID,Decision")] Review review)
        {
            ...
            ViewBag.ApplicantID = new SelectList(db.Applicants, "ID", "SSN", review.ApplicantID);
            return View(review);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ApplicantID,Decision")] Review review)
        {
            if (ModelState.IsValid)
            {
